...
def get_context(context):
	result = []
	q = "select name, subject, project, status, priority, exp_start_date, expected_time, task_weight, exp_end_date, progress, description, depends_on, depends_on_tasks, act_start_date, actual_time, act_end_date, total_costing_amount, total_expense_claim, total_billing_amount, review_date, closing_date, company from `tabWork Order`"
